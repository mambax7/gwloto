...
if (isset($_POST['ptid'])) {
    $currentpoint = (int)$_POST['ptid'];
} elseif (isset($_GET['ptid'])) {
    $currentpoint = (int)$_GET['ptid'];
}
...
if (isset($_POST['jsid'])) {
    $currentjobstep = (int)$_POST['jsid'];
} elseif (isset($_GET['jsid'])) {
    $currentjobstep = (int)$_GET['jsid'];
}
...
if (isset($_POST['pid'])) {
    $currentplace = (int)$_POST['pid'];
} elseif (isset($_GET['pid'])) {
    $currentplace = (int)$_GET['pid'];
}
